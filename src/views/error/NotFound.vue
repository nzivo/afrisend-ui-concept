  ...
  <div class="h-screen bg-gray-50 flex items-center">
    ...
    >
      <div class="w-full lg:w-1/2 mx-8">
        ...
        <RouterLink
          :to="{ name: 'home' }"
          class="px-5 inline py-3 text-sm font-medium leading-5 shadow-2xl text-white transition-all duration-400 border border-transparent rounded-lg focus:outline-none bg-green-600 active:bg-blue-600 hover:bg-blue-700"
